...
public class SpawnSteelArrowBroom extends SpawnEntityItem {
    public SpawnSteelArrowBroom(String name, CreativeTabs creativeTab) {
        super(name, creativeTab);
    }

    @Override
    public Entity getEntity(World world, ItemStack stack) {
        return new EntitySteelArrowBroom(world);
    }
}

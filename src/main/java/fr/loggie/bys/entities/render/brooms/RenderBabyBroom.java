...
public class RenderBabyBroom extends RenderLiving<EntityBabyBroom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BABY_BROOM.getCustomName();
    ...
    public RenderBabyBroom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBabyBroom entity) {
        return TEXTURES;
    }
}

...
import fr.loggie.bys.entities.FlyingBroomEntities.EntityBrossdur5Broom;
...
public class RenderBrossdur5Broom extends RenderLiving<EntityBrossdur5Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BROSSDUR_5.getCustomName();
    ...
    public RenderBrossdur5Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBrossdur5Broom entity) {
        return TEXTURES;
    }
}

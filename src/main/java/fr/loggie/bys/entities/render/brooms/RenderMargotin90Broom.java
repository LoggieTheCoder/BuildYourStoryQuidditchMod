...
import fr.loggie.bys.entities.FlyingBroomEntities.EntityManchevifBroom;
...
public class RenderMargotin90Broom extends RenderLiving<EntityMargotin90Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.MARGOTIN_90.getCustomName();
    ...
    public RenderMargotin90Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityMargotin90Broom entity) {
        return TEXTURES;
    }
}

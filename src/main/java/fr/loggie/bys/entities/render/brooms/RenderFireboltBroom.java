...
public class RenderFireboltBroom extends RenderLiving<EntityFireboltBroom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.FIREBOLT.getCustomName();
    ...
    public RenderFireboltBroom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityFireboltBroom entity) {
        return TEXTURES;
    }
}

...
public class RenderYajirushiBroom extends RenderLiving<EntityYajirushiBroom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.YAJIRUSHI.getCustomName();
    ...
    public RenderYajirushiBroom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture( EntityYajirushiBroom entity) {
        return TEXTURES;
    }
}

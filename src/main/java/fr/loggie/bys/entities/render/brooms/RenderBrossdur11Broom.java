...
public class RenderBrossdur11Broom extends RenderLiving<EntityBrossdur11Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BROSSDUR_11.getCustomName();
    ...
    public RenderBrossdur11Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBrossdur11Broom entity) {
        return TEXTURES;
    }
}

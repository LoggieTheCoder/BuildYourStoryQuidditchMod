...
public class RenderNimbus1001Broom extends RenderLiving<EntityNimbus1001Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.NIMBUS_1001.getCustomName();
    ...
    public RenderNimbus1001Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityNimbus1001Broom entity) {
        return TEXTURES;
    }
}

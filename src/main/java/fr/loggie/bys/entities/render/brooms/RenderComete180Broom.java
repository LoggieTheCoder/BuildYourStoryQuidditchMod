...
import fr.loggie.bys.entities.FlyingBroomEntities.EntityComete180Broom;
...
public class RenderComete180Broom extends RenderLiving<EntityComete180Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.COMETE_180.getCustomName();
    ...
    public RenderComete180Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityComete180Broom entity) {
        return TEXTURES;
    }
}

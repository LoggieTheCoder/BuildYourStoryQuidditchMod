...
public class RenderManchevifBroom extends RenderLiving<EntityManchevifBroom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.MANCHEVIF.getCustomName();
    ...
    public RenderManchevifBroom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityManchevifBroom entity) {
        return TEXTURES;
    }
}

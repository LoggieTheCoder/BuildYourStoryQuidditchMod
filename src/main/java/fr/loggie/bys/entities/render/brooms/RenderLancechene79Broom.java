...
public class RenderLancechene79Broom extends RenderLiving<EntityLancechene79Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.LANCECHENE_79.getCustomName();
    ...
    public RenderLancechene79Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityLancechene79Broom entity) {
        return TEXTURES;
    }
}

...
public class RenderBrossdur1Broom extends RenderLiving<EntityBrossdur1Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BROSSDUR_1.getCustomName();
    ...
    public RenderBrossdur1Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBrossdur1Broom entity) {
        return TEXTURES;
    }
}

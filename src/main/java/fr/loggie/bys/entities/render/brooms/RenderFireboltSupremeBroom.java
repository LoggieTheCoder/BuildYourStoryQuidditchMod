...
public class RenderFireboltSupremeBroom extends RenderLiving<EntityFireboltSupremeBroom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.FIREBOLT_SUPREME.getCustomName();
    ...
    public RenderFireboltSupremeBroom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture( EntityFireboltSupremeBroom entity) {
        return TEXTURES;
    }
}

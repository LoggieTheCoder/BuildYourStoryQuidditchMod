...
public class RenderNimbus1000Broom extends RenderLiving<EntityNimbus1000Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.NIMBUS_1000.getCustomName();
    ...
    public RenderNimbus1000Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityNimbus1000Broom entity) {
        return TEXTURES;
    }
}

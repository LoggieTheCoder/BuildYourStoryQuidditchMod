...
public class RenderComete260Broom extends RenderLiving<EntityComete260Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.COMETE_260.getCustomName();
    ...
    public RenderComete260Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityComete260Broom entity) {
        return TEXTURES;
    }
}

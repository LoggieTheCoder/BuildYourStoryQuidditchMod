...
public class RenderNimbus1500Broom extends RenderLiving<EntityNimbus1500Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.NIMBUS_1500.getCustomName();
    ...
    public RenderNimbus1500Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityNimbus1500Broom entity) {
        return TEXTURES;
    }
}

...
import fr.loggie.bys.entities.FlyingBroomEntities.EntityBrossdur6Broom;
...
public class RenderBrossdur6Broom extends RenderLiving<EntityBrossdur6Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BROSSDUR_6.getCustomName();
    ...
    public RenderBrossdur6Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBrossdur6Broom entity) {
        return TEXTURES;
    }
}

...
public class RenderBaletoileXXIBroom extends RenderLiving<EntityBaletoileXXIBroom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BALETOILE_XXI.getCustomName();
    ...
    public RenderBaletoileXXIBroom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture( EntityBaletoileXXIBroom entity) {
        return TEXTURES;
    }
}

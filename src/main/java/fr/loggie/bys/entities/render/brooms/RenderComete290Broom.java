...
import fr.loggie.bys.entities.FlyingBroomEntities.EntityComete290Broom;
...
public class RenderComete290Broom extends RenderLiving<EntityComete290Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.COMETE_290.getCustomName();
    ...
    public RenderComete290Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityComete290Broom entity) {
        return TEXTURES;
    }
}

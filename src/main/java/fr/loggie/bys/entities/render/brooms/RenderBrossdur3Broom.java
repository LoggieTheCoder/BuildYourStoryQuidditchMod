...
import fr.loggie.bys.entities.FlyingBroomEntities.EntityBrossdur3Broom;
...
public class RenderBrossdur3Broom extends RenderLiving<EntityBrossdur3Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.BROSSDUR_3.getCustomName();
    ...
    public RenderBrossdur3Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityBrossdur3Broom entity) {
        return TEXTURES;
    }
}

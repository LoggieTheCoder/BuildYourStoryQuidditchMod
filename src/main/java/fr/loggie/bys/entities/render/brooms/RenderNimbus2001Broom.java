...
public class RenderNimbus2001Broom extends RenderLiving<EntityNimbus2001Broom> {
    public static final String UNLOCALISED_NAME = EntityFlyingBroom.FlyingBrooms.NIMBUS_2001.getCustomName();
    ...
    public RenderNimbus2001Broom(RenderManager rendermanagerIn) {
        super(rendermanagerIn,MODEL,0.5F);
    }

    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityNimbus2001Broom entity) {
        return TEXTURES;
    }
}
